...
const buttonStyle = tva({
  ...
  variants: {
    action: {
      ...
      default: 'bg-transparent data-[active=true]:bg-transparent data-[hover=true]:bg-background-50',
    },
    variant: {
      link: 'px-0',
      outline: 'border bg-transparent data-[active=true]:bg-transparent data-[hover=true]:bg-background-50',
      solid: '',
    },
  ...
  compoundVariants: [
    {
      action: 'primary',
      variant: 'link',
      class: 'bg-transparent px-0 data-[active=true]:bg-transparent data-[hover=true]:bg-transparent',
    },
    {
      action: 'secondary',
      variant: 'link',
...
const buttonTextStyle = tva({
  ...
  parentVariants: {
    action: {
      primary: 'text-primary-600 data-[active=true]:text-primary-700 data-[hover=true]:text-primary-600',
      secondary: 'text-typography-500 data-[active=true]:text-typography-700 data-[hover=true]:text-typography-600',
      positive: 'text-success-600 data-[active=true]:text-success-700 data-[hover=true]:text-success-600',
    ...
    variant: {
      ...
      outline: '',
      solid: 'text-typography-0 data-[active=true]:text-typography-0 data-[hover=true]:text-typography-0',
    },
    size: {
      xs: 'text-xs',
      sm: 'text-sm',
  ...
  parentCompoundVariants: [
    {
      variant: 'solid',
      action: 'primary',
      class: 'text-typography-0 data-[active=true]:text-typography-0 data-[hover=true]:text-typography-0',
    },
    {
      variant: 'solid',
      action: 'secondary',
      class: 'text-typography-800 data-[active=true]:text-typography-800 data-[hover=true]:text-typography-800',
    },
    {
      variant: 'solid',
      action: 'positive',
    ...
    },
    {
      variant: 'outline',
      action: 'primary',
      class: 'text-primary-500 data-[active=true]:text-primary-500 data-[hover=true]:text-primary-500',
    },
    {
      variant: 'outline',
      action: 'secondary',
      class: 'text-typography-500 data-[active=true]:text-typography-700 data-[hover=true]:text-primary-600',
    },
    {
      variant: 'outline',
      action: 'positive',
